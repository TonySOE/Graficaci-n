...
Al igual que el proyecto individual, se debe de realizar un proyecto que escale y traslade un mapa creado con el modelado de una ciudad con variedad de objetos.
...
![Camara2](Imagenes/Camara2.png)

**Mapa cambiado**

![Ciudad2](Imagenes/Ciudad2.png)

**Mapa cambiado**

![Ciudad3](Imagenes/Ciudad3.png)

**Movimientos**

- Mover hacia los lados los puntos hace que se pueda mover el mapa.

- Mover hacia arriba los puntos acerca la imagen del mapa.

- Mover los puntos hacia abajo aleja el mapa.
